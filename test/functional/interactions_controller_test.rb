...
class InteractionsControllerTest < ActionController::TestCase
  ...
  test "should create interaction" do
    assert_difference('Interaction.count') do
      post :create, interaction: { action_name: @interaction.action_name, controller_name: @interaction.controller_name }
    end
  ...
  test "should update interaction" do
    put :update, id: @interaction, interaction: { action_name: @interaction.action_name, controller_name: @interaction.controller_name }
    assert_redirected_to interaction_path(assigns(:interaction))
  end
